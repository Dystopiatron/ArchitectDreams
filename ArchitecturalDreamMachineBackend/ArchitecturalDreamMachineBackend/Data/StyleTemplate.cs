...
public class StyleTemplate
{
    ...
    public double TypicalCeilingHeight { get; set; } = ArchitecturalConstants.DefaultCeilingHeight; // 8, 9, 10, 12 ft
    public int TypicalStories { get; set; } = 1; // 1, 2, 3
    public string BuildingShape { get; set; } = "rectangular"; // "rectangular", "l-shape", "u-shape"
    public double WindowToWallRatio { get; set; } = ArchitecturalConstants.DefaultWindowToWallRatio; // 10%-30%
    ...
    public double RoofPitch { get; set; } = ArchitecturalConstants.DefaultRoofPitch; // 4/12, 6/12, 8/12, 12/12 (0 for flat)
    public bool HasParapet { get; set; } = false; // Modern flat roofs
    public bool HasEaves { get; set; } = true; // Overhanging eaves
    public double EavesOverhang { get; set; } = ArchitecturalConstants.DefaultEavesOverhang; // 1.0, 1.5, 2.0 ft
}
